...
# Bot information
API_ID = environ.get('API_ID', '24799187')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '4baef40b8f24b66a25ccd232861186ed') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '8887127574:AAHZ97-wwawXEZId5B80hfGPXlPbGQomY44') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1003622614396') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1003449452691') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Kingkishan1:229961@cluster1.dmixne4.mongodb.net/?appName=Cluster1") #mongo db url
...
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/Epic_Supports')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/169d21f1a50bb4f34a387-524467302bc984cc73.jpg') #telegraph link of your QR code 
UPI_ID = environ.get('UPI_ID', 'manjappashirattti84-1@okicici') # Add your upi id here
# for stream
IS_STREAM = is_enabled('IS_STREAM', True) #true if you want stream feature active in your bot
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1003777314225") #if is_stream = true then add a channel id ex: -10026393639
